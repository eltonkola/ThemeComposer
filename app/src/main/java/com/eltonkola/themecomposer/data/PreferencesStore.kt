...
val defaultTheme = AppThemes(
    light = AppThemeColors(
        primary = Color(0xFFC40239),
        primaryVariant = Color(0xFF990474),
        secondary = Color(0xFF5C06C5),
        background = Color(0xFFA394B6),
        surface = Color(0xFFB3A9C0),
        onPrimary = Color(0xFF4902A0),
